...
Each course consists of two sections, each comprising a lecture and an activity session with questions. In the first half of the lecture, you will engage in activity 1, while activity 2 will be conducted after the second half of the lecture in each class.
  ...
  <tr>
    ...
    <td>
      <ul>
        ...
        <li><a href="files/lec5/one-way_anova.pzfx">One-way ANOVA</a></li>
        <li><a href="files/lec5/two-way_anova.pzfx">Two-way ANOVA</a></li>
